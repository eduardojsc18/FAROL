        ...
        <div class="max-sm:mt-3 max-sm:col-span-full md:rounded-l-2xl max-sm:rounded-t-2xl">
            ...
            <a :href="item.permalink" target="_blank">
                <div class="flex items-center gap-3 group hover:bg-neutral-700 -m-2 p-2 rounded-xl">
                    <img :src="item.thumbnail" alt="" class="aspect-square rounded-lg object-center object-cover size-16">
                    <div>
                        <p>
                            {{ item.title }}
            ...
            <div class="flex justify-center h-full">
                <div class="flex flex-col gap-1 justify-between">
                    ...
                    <div class="flex justify-center">
                        <div v-if="item.catalog_listing" data-tooltip="Catálogo" class="bg-blue-800 text-white p-1 rounded-md text-xs flex items-center justify-center gap-1">
            ...
            <div class="flex justify-center">
                <div class="text-base flex flex-col h-full gap-1 justify-between">
                    ...
                    <div class="flex justify-center min-h-5">
                        <div v-if="item.shipping.logistic_type === 'fulfillment'" class="flex items-center gap-1 font-bold text-green-600">
