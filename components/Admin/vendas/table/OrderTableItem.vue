<template>
    <tr>
        <td class="whitespace-nowrap px-3 py-4 text-sm text-center dark:text-primary-200">
        ...
        <td class="whitespace-nowrap px-3 py-4 text-center text-sm font-medium sm:pr-0">
            <div class="flex justify-center">
                <svg v-if="details.delivery.tracking_method === 'PAC' || details.delivery.tracking_method === 'Sedex'" class="size-8" width="281" height="205" viewBox="0 0 281 205" fill="none" xmlns="http://www.w3.org/2000/svg">
