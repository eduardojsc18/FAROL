<template>
    <div class="max-w-xl w-full relative" :data-show-drop-down="showDropDown" v-click-away="() => showDropDown = false">
        ...
        >
            <div v-if="showDropDown" class="absolute top-full grid place-items-center left-0 min-h-64 overflow-y-auto max-h-80 w-full rounded-lg ring-[1px] ring-neutral-500/40 bg-neutral-50 dark:bg-neutral-800/90 backdrop-blur-2xl shadow-md mt-2 p-2">
