<template>
    <div class="flex justify-center items-center whitespace-nowrap">
        <svg class="size-7 scale-x-[-1] fill-orange-600" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <span class="text-3xl font-thin text-orange-600">FAROL</span>
    </div>
</template>
<script setup>
//Props
