<template>
    ...
    >
        ...
        <NuxtLink
            :to="props.to"
            class="grow flex items-center -ml-1 gap-5 group py-2 transition-all text-neutral-700 hover:text-orange-400 rounded-md text-sm *:has-[svg]:flex-shrink-0 overflow-hidden"
            :class="!useSidebar().minify ? 'px-5' : 'px-4'"
