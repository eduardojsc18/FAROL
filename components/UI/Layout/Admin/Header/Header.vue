<template>
    <header class="max-md:sticky max-md:top-0 max-md:bg-[#fffbf6] dark:max-md:bg-[#18181999] max-md:backdrop-blur flex justify-between items-center py-2.5 gap-5 px-3">
        <SidebarButtonShow />
        <InputSearchAll />
