<template>
    <li class="relative">
        <NuxtLink
            :to="props.href"
            class="
                text-sm flex items-center gap-1 py-2 px-4 font-medium transition-colors relative
                after:absolute after:-bottom-px after:inset-x-2 after:h-px after:rounded-full after:opacity-0 after:transition-opacity
